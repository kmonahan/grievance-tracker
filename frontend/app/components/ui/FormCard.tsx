  ...
  return (
    <main className="w-full mx-auto px-6 py-8 flex items-center justify-center">
      <div className="w-full max-w-md">
        <div className="mt-8 bg-card text-primary flex flex-col gap-6 rounded-xl border py-6 border-primary/20 shadow-l">
          ...
          <form className="px-6 flex flex-col pb-6 gap-4 items-start" action={action}>
            {children}
          </form>
        </div>
      </div>
