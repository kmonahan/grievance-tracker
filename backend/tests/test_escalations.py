    ...
    def test_get_recent_activity(self, _mock_verify_jwt, client):
        ...
        assert res.json == [
            {'date': '2026-01-09', 'date_due': '2026-01-30', 'deadline_missed': False, 'grievance': 'Test #2',
             'grievance_id': 2, 'hearing_date': None, 'id': 5, 'status': 'Prepare for Next Step', 'step': 'Step #1',
             'user': {'id': 2, 'is_active': True, 'name': 'Dolores Huerta'}},
            {'date': '2026-01-09', 'date_due': '2026-01-15', 'deadline_missed': False, 'grievance': 'Test #4',
             'grievance_id': 4, 'hearing_date': None, 'id': 6, 'status': 'Waiting to Schedule', 'step': 'Step #2',
            ...
            {'date': '2026-01-10', 'date_due': None, 'deadline_missed': False, 'grievance': 'Test #4',
             'grievance_id': 4, 'hearing_date': None, 'id': 7, 'status': 'In Abeyance', 'step': 'Step #2',
             'user': {'id': 1, 'is_active': True, 'name': 'Walter Reuther'}}]
