...
VALUES
    ...
    ('ONE', 'IN_ABEYANCE', NULL, NULL),
    ('ONE', 'WITHDRAWN', NULL, NULL),
    ('TWO', 'WAITING_TO_SCHEDULE', 10, 'WORKING'),
    ('TWO', 'SCHEDULED', NULL, NULL),
    ('TWO', 'WAITING_ON_DECISION', 6, 'WORKING'),
    ('TWO', 'WAITING_TO_FILE', 30, 'WORKING'),
    ('TWO', 'RESOLVED', NULL, NULL),
    ('TWO', 'DENIED', NULL, NULL),
    ('TWO', 'IN_ABEYANCE', NULL, NULL),
    ('TWO', 'WITHDRAWN', NULL, NULL),
    ('THREE', 'WAITING_TO_SCHEDULE', 10, 'WORKING'),
    ('THREE', 'SCHEDULED', NULL, NULL),
    ('THREE', 'WAITING_TO_FILE', 40, 'WORKING'),
    ('THREE', 'RESOLVED', NULL, NULL),
    ('THREE', 'DENIED', NULL, NULL),
    ('THREE', 'IN_ABEYANCE', NULL, NULL),
    ('THREE', 'WITHDRAWN', NULL, NULL);
