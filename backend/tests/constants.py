...
TEST_GRIEVANCE = {'id': 1, 'name': 'Test #1', 'date': '2025-12-19', 'description': 'Test description #1', 'category': 'Pay',
...
TEST_GRIEVANCE_2 = {'id': 2, 'name': 'Test #2', 'date': '2025-12-19', 'description': 'Test description #2', 'category': 'Pay',
...
TEST_GRIEVANCE_3 = {'id': 3, 'name': 'Test #3', 'date': '2025-12-21', 'description': 'Test description #3', 'category': 'PTO',
                    'point_person': 'Clara Lemlich', 'secondary': 'Clara Lemlich', 'escalations': []}

TEST_GRIEVANCE_4 = {'id': 4, 'name': 'Test #4', 'date': '2026-01-09', 'description': 'Test description #4', 'category': 'PTO',
...
TEST_CREATED_GRIEVANCE = {'id': 5, 'name': TEST_CREATED_GRIEVANCE_PARTIAL['name'], 'date': '2025-12-19',
